...
describe('buildOutputFilename', () => {
  it('appends resolution to basename', () => {
    expect(buildOutputFilename('screen.png', 1242, 2688, new Set())).toBe(
      'screen_1242x2688.png'
    )
  })

  it('preserves jpeg extension', () => {
    expect(buildOutputFilename('photo.jpg', 1242, 2688, new Set())).toBe(
      'photo_1242x2688.jpg'
    )
  })

  it('uses png extension for webp input', () => {
    expect(buildOutputFilename('shot.webp', 1242, 2688, new Set())).toBe(
      'shot_1242x2688.png'
    )
  })
